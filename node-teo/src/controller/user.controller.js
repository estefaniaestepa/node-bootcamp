// Esas funciones son un poco diferentes de las normales. Sirven para crearse un usuario, autentificarse, deslogarse, etc.
  ...
  try {
    ...
    if (bcrypt.compareSync(request.body.password, userInfo.password)) {
      ...
      const token = jwt.sign(
        ...
        request.app.get("secretKey"), // secretKey es la palabra clave de autentificación. En este caso, con cualquier generador de contraseña, generamos una contraseña más compleja.
        // request.app.get("26qyMoCAEPn58iZHQLwoY3"),
        { expiresIn: "1d" }
      );
